...
export function initModels(sequelize: Sequelize) {
  ...
  Notification.belongsTo(ReReview, { as: "rereview", foreignKey: "rereview_id"});
  ReReview.hasMany(Notification, { as: "Notifications", foreignKey: "rereview_id"});
  ...
  Review.hasMany(Notification, { as: "Notifications", foreignKey: "review_id"});
