...
export type ReReviewOptionalAttributes =
  | 'id'
  | 'contents'
  | 'createdAt'
  | 'updatedAt';
export type ReReviewCreationAttributes = Optional<
  ReReviewAttributes,
  ReReviewOptionalAttributes
>;

export class ReReview
  extends Model<ReReviewAttributes, ReReviewCreationAttributes>
  implements ReReviewAttributes
{
  id!: number;
  review_id!: number;
  shop_id!: number;
  ...
  // ReReview hasMany Notification via rereview_id
